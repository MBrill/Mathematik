...
public class LinearCongruentalGenerator {
	...
	/**
	 * Konstruktor mit einem Startwert, alle anderen Gr��en werden wie der 
	...
	/** 
	 * Den Modul abfragen (die grö�te Zahl die produziert werden kann ist m-1) 
	 * 
