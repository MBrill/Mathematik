...
public class MCPiMeans extends MCPiAbstract 
{
	public static void main(String[] args) {
		...
		System.out.println("Wir f�hren insgesamt " + n + "-mal dieses Experiment durch und berechnen das arithmetische Mittel");
		...
		// Wir bilden die arithmetische Mittel der relativen Häufigkeiten und der Schätzungen
		int summehK = 0;
		double summe = 0.0;
		for (i=0; i<n; i++)
		{
