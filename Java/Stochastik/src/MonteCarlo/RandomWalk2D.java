...
public class RandomWalk2D {
	...
	/**
	 * Die Simulation durchf�hren.
	 * 
	 * Wir haben mehrere Abbruchkriterien.
	 * Einmal, ob wir unser Ziel erreicht haben.
	 * Und dann noch die beiden Abbr�che, wenn wir den Bereich verlassen
	...
	/**
	 * �berpr�fung, ob die aktuelle Position mit dem Ziel �bereinstimmt.
	 * 
	 ...
	 * Entscheidung, die mit Hilfe eines Mersenne Twisters gef�llt wird.
	 */
	...
	/**
	 * Überpr�fen, ob eine Position innerhalb des Bereichs liegt.
	 * 
